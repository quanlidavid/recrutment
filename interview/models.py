...
# 复试面试建议
SECOND_INTERVIEW_RESULT_TYPE = ((u'建议复试', u'建议复试'), (u'待定', u'待定'), (u'放弃', u'放弃'))
...
class Candidate(models.Model):
    ...
    second_result = models.CharField(max_length=256, choices=SECOND_INTERVIEW_RESULT_TYPE, blank=True,
    ...
    hr_score = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR复试综合等级',
                                help_text=u'极优秀：S, 优秀：A，良好：B，一般：C。')
    ...
    hr_result = models.CharField(max_length=256, choices=SECOND_INTERVIEW_RESULT_TYPE, blank=True,
    ...
    # Python 2 优先使用这个方法，把对象转换成字符串；如果没有__unicode__()方法，使用__str__()方法
    def __unicode__(self):
        return self.username

    # Python 3 直接定义__str__()方法即可，系统使用这个方法来把对象转换成字符串
    def __str__(self):
        return self.username
